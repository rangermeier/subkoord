...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Wikipage.content'
        db.delete_column('wiki_wikipage', 'content')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Wikipage.content'
        raise RuntimeError("Cannot reverse this migration. 'Wikipage.content' and its values cannot be restored.")
