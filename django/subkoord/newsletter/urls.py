...
urlpatterns = patterns('subkoord.newsletter.views',
	...
	url(r'^list/(?P<list_id>\d+)/add/$', 'subscribers_add', name="subscribers_add"),
	url(r'^list/(?P<list_id>\d+)/subscribe$', 'subscriber_add', name="subscriber_add"),
	url(r'^list/(?P<list_id>\d+)/$', 'subscribers_list', name="subscribers_list"),
	url(r'^job/(?P<job_id>\d+)$', 'job', name="job"),
	url(r'^job/new/$', 'job_new', name="job_new"),
	url(r'^job/archive/$', 'job_archive', name="job_archive"),
)
